...
<div class="row overview-container">
    ...
    <div class="col-sm-6">
	<div class="functions">
		<h2 style="padding-bottom:1%;color:#006400;">MinaMata & Sound chemical Management</h2>
        <h3>MinaMata</h3>
        <p>
