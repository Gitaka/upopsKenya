...
<div class="row overview-container">
    <div class="col-sm-3">
    	<!--<div class="projects">
    	  ...
    	  <div class="projects">
    		<h3 style="color:#b52e31">Documents</h3></br>
    		<a href="#"><img src="{{asset('images/saicm.png')}}" width="100" height="100" data-selector="img" alt=""></a>
            <p class="p-style">
       	     <span><a href="downloads/SAICM_Brochure-2015.pdf" download></span>SAICM Fundraising Letter by ICCM5 President.</a></p>
    	</div>
    </div>
    <div class="col-sm-6">
	<div class="functions">
		<h2 style="padding-bottom:1%;color:#006400;">Strategic Approach To International Chemicals Management</h2>
        <h3>Overview</h3>
        <p style="font-weight:bolder;">Adopted by the First International Conference on Chemicals Management (ICCM1) on 6 February 2006 in Dubai, the Strategic Approach to International Chemicals Management (SAICM) is a policy framework to promote chemical safety around the world.</p>
       <p>
       ...
       <p>
       	The consumption of chemicals by all industries and modern society’s reliance on chemicals for virtually all manufacturing processes make chemicals production one of the major and most globalized sectors of the world economy.
       </p>
       <p>
       	Acknowledgement of the essential economic role of chemicals and their contribution to improved living standards needs to be balanced with recognition of potential costs. These include the chemical industry’s heavy use of water and energy and the potential adverse impacts of chemicals on the environment and human health. The diversity and potential severity of such impacts makes sound chemicals management a key cross-cutting issue for sustainable development.
       </p>
       <p>
       ...
       <p>
       	Objectives are grouped under five themes: risk reduction; knowledge and information; governance; capacity-building and technical cooperation; and illegal international traffic.
       </p>
       <p>
