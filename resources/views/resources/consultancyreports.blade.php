...
<div class="row overview-container" style="background-color:#f8f8f8">
 <div class="row resources-panel">
 	...
 	<div class="col-sm-5 r-panel-1">
 		...
 		<div class="r-panel-body">
 			<h5>Awareness on environmentally Sound Solid Waste</h5></br>
 			<h6><strong>Category:</strong>
                <span>Consultancy Report</span>
 			</h6>
 		</div>
 		<div class=" well well-sm r-panel-footer">
 		  <a href="downloads/Awareness on environmentally Sound Solid Waste Management .pdf" download>
 	...
 	<div class="col-sm-5 r-panel-1">
 		...
 		<div class="r-panel-body" style="100px">
 			<h5>Institutional Needs Analysis for Chemicals and Waste Management in Kenya</h5></br>
 			<h6><strong>Category:</strong>
                <span>Consultancy Report</span>
 			</h6>
 		</div>
 		<div class=" well well-sm r-panel-footer">
 		  <a href="downloads/Institutional Needs Analysis for Chemicals and Waste Management in Kenya.pdf" download>
 			<button class="btn btn-lg btn-primary" style="width:100%">
 			<span>Download</span>&nbsp;&nbsp;&nbsp;&nbsp;
 			<span><i class="fa fa-download" style="color:#fff">&nbsp;</i></span>
 ...
 <div class="row resources-panel">
 	...
 	<div class="col-sm-5 r-panel-1">
 		...
 		<div class="r-panel-body">
 			<h5>Review of National Guidelines for Safe Management of Health Care Waste 
             </br>
 			</h5></br>
 			<h6><strong>Category:</strong>
                <span>Consultancy Report</span>
 		...
 		<div class=" well well-sm r-panel-footer">
 		  <a href="downloads/Review of National Guidelines for Safe Management of Health Care Waste.pdf" download>
 			<button class="btn btn-lg btn-primary" style="width:100%">
 			<span>Download</span>&nbsp;&nbsp;&nbsp;&nbsp;
 			<span><i class="fa fa-download" style="color:#fff">&nbsp;</i></span>
 	...
 	<div class="col-sm-5 r-panel-1">
 		...
 		<div class="r-panel-body" style="100px">
 			<h5>Training Needs Assessment of Health Workers on Health Care Waste Management in Kenya</h5></br>
 			<h6><strong>Category:</strong>
                <span>Consultancy Report</span>
 			</h6>
 		</div>
 		<div class=" well well-sm r-panel-footer">
 		  <a href="downloads/Training Needs Assessment of Health Workers on Health Care Waste Management in Kenya.pdf" download>
 			<button class="btn btn-lg btn-primary" style="width:100%">
 			<span>Download</span>&nbsp;&nbsp;&nbsp;&nbsp;
 			<span><i class="fa fa-download" style="color:#fff">&nbsp;</i></span>
