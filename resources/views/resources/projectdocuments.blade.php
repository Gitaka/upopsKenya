 ...
 <div class="row resources-panel">
    ...
    <?php echo $reports->render(); ?>
 	<div class="col-sm-5 r-panel-1">
 		...
 		<div class="r-panel-body">
 			<h5>SAICM-IMPLEMENTATION-PLAN-FOR-Kenya</h5></br>
 			<h6><strong>Category:</strong>
...
THE ROLE OF MASS COMMUNICATION AND JOURNALISM IN CHEMICALS MANAGEMENT IN THE ENGLISH SPEAKING AFRICAN COUNTRIES
 		...
 		<div class=" well well-sm r-panel-footer">
 		  <a href="downloads/Pretoria Chemicals Report.pdf" download>
 			<button class="btn btn-lg btn-primary" style="width:100%">
 			<span>Download</span>&nbsp;&nbsp;&nbsp;&nbsp;
 			<span><i class="fa fa-download" style="color:#fff">&nbsp;</i></span>
 ...
 <div class="row resources-panel">
 	...
 	<div class="col-sm-5 r-panel-1">
 		...
 		<div class="r-panel-body">
 			<h5>Sound Chemicals Management Mainstreaming and UPOPs reduction in Kenya.
             </br>
 			</h5></br>
 			<h6><strong>Category:</strong>
 		...
 		<div class=" well well-sm r-panel-footer">
 		  <a href="downloads/Kenya ProDoc.pdf" download>
 			<button class="btn btn-lg btn-primary" style="width:100%">
 			<span>Download</span>&nbsp;&nbsp;&nbsp;&nbsp;
 			<span><i class="fa fa-download" style="color:#fff">&nbsp;</i></span>
