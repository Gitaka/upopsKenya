...
<div class="container">
     ...
     @if(Session::has('successGallery'))
            <p class="alert alert-success">{{Session::get('successGallery')}}</p>
         @endif
                       @if (count($errors) > 0)
                    ...
                    @endif
                            ...
                            method="POST" action="{{url('addToGallery')}}"enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="firstname" class="col-md-4 control-label">Image</label>
                                    <div class="col-md-8">
