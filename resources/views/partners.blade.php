...
<div class="row">
	...
	<div class="col-sm-9" style="padding:5%;">
        <h3 style="padding-bottom:1%;color:#006400;">Our key Partners that are  directly involved in the Project’s Components and activities.</h3>  
        <h4>1.	Government Institutions</h4>
        <p>-	Ministry of Health </p>
        <p>-	County Governments of Kisumu, Nairobi, Nakuru and Mombasa </p>
        <p>-	NEMA</p>
        <p>-	Government Chemist</p>
        <p>-	Water Resources Authority (WRA)</p>
        <p>-	Pest Control Products Board (PCPB)</p>
        </br>
        ...
        <p>-	Kenya Plant Health Inspectorate Services (KEPHIS)</p>
        <p>-	Mathari Teaching and Referral Hospital</p>
