...
<div class="row overview-container">
    <div class="col-sm-3">
    	<!--<div class="projects">
    		<h3 style="color:#b52e31">Report of the First Session</h3></br>
    		<p>
SAICM/ICCM.1/7 - Report of the International Conference on Chemicals Management on the work of its first session
    		</p>
    	</div>-->
    	  <div class="projects">
    		<h3 style="color:#b52e31">Text Documents</h3></br>
    		<a href="#"><img src="{{asset('images/ICCM1.jpg')}}" width="100" height="100" data-selector="img" alt=""></a>
            <p class="p-style">
       	     <span><a href="downloads/SAICM-IMPLEMENTATION-PLAN-FOR-Kenya.pdf" download></span>SAICM-IMPLEMENTATION-PLAN-FOR-Kenya</a></p>
    	</div>
    </div>
    <div class="col-sm-6">
	<div class="functions">
		<h2 style="padding-bottom:1%;color:#006400;">Kenya SAICM Implementation Plan</h2>
            <p>
            	This SAICM implementation plan for Kenya was prepared under the project, Strengthening National and Regional. Capacities for Sound Chemicals Management and SAICM Implementation in Kenya supported by the and The. United Nations Institute for Training and Research (UNITAR), in collaboration with the Ministry of environment and natural resources.
            </p>
           <br>
          <h5>Download document on: 
            <a href="downloads/SAICM-IMPLEMENTATION-PLAN-FOR-Kenya.pdf" download style="color:red"></span>SAICM-IMPLEMENTATION-PLAN-FOR-Kenya</a>
