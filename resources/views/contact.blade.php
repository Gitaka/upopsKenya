				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu-hover-effect menu-hover-effect-4">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="{{url('contactUs')}}" class="hvr-ripple-in">Contact Us</a></li>
						</ul>
					</nav>
   ...
   <h2>Contact Us</h2>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <address>
                <strong>Ministry of Environment And Natural Resources.</strong><br>
                NHIF BUILDING, 12th Floor<br>
                Ragati Road, UpperHill.<br>
