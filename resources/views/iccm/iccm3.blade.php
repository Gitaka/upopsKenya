    ...
    <div class="col-sm-3">
    	<div class="projects">
    	  ...
    	  <div class="projects">
    		...
    		<a href="#"><img src="{{asset('images/iccm3.jpg')}}" width="100" height="100" data-selector="img" alt=""></a>
            <p class="p-style">
       	     <span><a href="downloads/ICCM3 1 prov agenda E.pdf" download></span>Provisional Agenda.</a></p>
    	</div>
    </div>
    <div class="col-sm-6">
	<div class="functions">
		<h2 style="padding-bottom:1%;color:#006400;">Third session of the International Conference on Chemicals Management (ICCM3)</h2>
        <h3>Overview</h3>
        <h5>Nairobi, Kenya, 17-21 September 2012</h5></br>
        <p>ICCM3 marked a major milestone in the implementation of the Strategic Approach since its adoption in 2006. For the first time, the Conference reviewed progress in the implementation of the Strategic Approach with tangible data on the 20 indicators of progress adopted at the second session. </p>
        <p>
      The Conference evaluated implementation, addressed emerging policy issues, considered new activities for addition to the Global Plan of Action, evaluated the financing of the Strategic Approach and took strategic decisions for the future including the consideration of recommendations from the Executive Board of the Quick Start Programme regarding the future of the Programme and its trust fund, as contributions will only be accepted until September 2012. ICCM3 featured a high-level dialogue, incorporating opportunities for formal statements, as well as other special events. The working languages for the third session of the Conference were Arabic, Chinese, English, French, Russian and Spanish. The session was be opened at 10 a.m. on Monday, 17 September 2012.
        </p>
           <br>
