...
SAICM/ICCM.1/7 - Report of the International Conference on Chemicals Management on the work of its first session
    	  ...
    	  <div class="projects">
            ...
            <p class="p-style">
       	     <span><a href="downloads/Final ICCM1 Report Eng.pdf" download></span>Report of the International Conference on Chemicals Management on the work of its first session.</a></p>
    	</div>
    </div>
    <div class="col-sm-6">
	<div class="functions">
		<h2 style="padding-bottom:1%;color:#006400;">First session of the International Conference on Chemicals Management (ICCM1)</h2>
        <h3>Overview</h3>
        <h5>Dubai, United Arab Emirates, 4-6 February 2006</h5><br>
