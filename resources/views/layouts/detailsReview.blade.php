...
<div class="container">
	...
	<div class="row">
  	<div class="row">
           ...
           @endif
  		<div class="col-sm-9"><h2 style="color:#3c763d">Application Details</h2></div>
          ...
          <div class="row">
           ...
           <div class="row" style="margin-bottom:3%;margin-top:2%">
              <div class="col-md-offset-4 col-md-9">
                    <button id="btn-signup" type="submit" class="btn btn-info btn-lg"><i class="icon-hand-right"></i><a href="{{url('/acceptApplication')}}/{{$detail->id}}" style="color:#fff">Accept Application</a></button>
