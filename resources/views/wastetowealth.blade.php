				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu-hover-effect menu-hover-effect-4">
						<ul class="nav navbar-nav">
							...
							<li class="dropdown">
								<a href="{{url('workshops')}}" class="dropdown-toggle hvr-ripple-in" data-toggle="dropdown">Resources<b class="fa fa-caret-down" aria-hidden="true"></b></a>
								<ul class="dropdown-menu agile_short_dropdown">
...
<div class="row">
	<div class="col-sm-3 gallery-left">
	       <a href="{{url('project_documents')}}">
		    <button class="btn btn-lg btn-primary" style="width:100%;border-radius:0px">
	      ...
	      <a href="{{url('events')}}">
		    <button class="btn btn-lg btn-primary" style="width:100%;border-radius:0px">
		    <span><i class="fa fa-calendar" style="color:#fff">&nbsp;</i></span>
 			   <span>Events</span>
 			</button> 	       	
	       </a> </br> </br>
	        <a href="{{url('news')}}">
		    <button class="btn btn-lg btn-primary" style="width:100%;border-radius:0px">
		    <span><i class="fa fa-newspaper-o" style="color:#fff">&nbsp;</i></span>
 			   <span>News</span>
 			</button> 	       	
	       </a>
	...
	<div class="col-sm-9" style="padding:5%;">
      <h2 style="color:#006400;">Waste to Wealth</h2></br>
      <p><span style="font-weight:bold">Overview</span>
      <p>Waste is anything that people do not value anymore and would love to throw away.
These things are now waste because you have no further need for them and would like to dispose them.
However, waste isn’t entirely useless because there are people and businesses who’ll pay to have them.
Waste will remain a part of our lives for as long as we exist. Statistics say that on average, a person produces 1.2 Kgs of waste in a day, however, this has increased to 1.42kgs a day hence becoming a daily menace in the way that is it managed or disposed
</p>
<p>The most common types of solid waste are: domestic waste (garbage and rubbish produced by individuals and households), commercial waste (solid waste coming from business places such as stores, markets, office buildings, restaurants, shops, bars, etc.), and industrial waste (produced by factories and processing plants.</p>
<p>The network of Waste to Wealth was created in Nakuru in 2017 to encourage entrepreneurship in the area of recycling and compost in order to reduce the amounts of wastes going into the dumpsite as well create business opportunities to its members</p></br>
<p><span style="font-weight:bold">Exhibition</span>
	</div>
			...
			<div class="col-sm-3 ">
				<div class="gallery-image">
					...
					<div class="gallery-image-body">
						<img src="{{asset('images/gallery/IMG_20170725_094517.jpg')}}"  width="100%" height="100%">
					</div>
				</div>
			</div>
			<div class="col-sm-3 ">
				<div class="gallery-image">
					...
					<div class="gallery-image-body">
						<img src="{{asset('images/gallery/IMG_20170726_111633.jpg')}}"  width="100%" height="100%">
					</div>
				</div>				
			</div>
			<div class="col-sm-3">
				<div class="gallery-image">
					...
					<div class="gallery-image-body">
						<img src="{{asset('images/gallery/IMG_20170726_111654.jpg')}}"  width="100%" height="100%">
					</div>
				</div>
			</div>
			<div class="col-sm-3">
				<div class="gallery-image">
					...
					<div class="gallery-image-body">
						<img src="{{asset('images/gallery/IMG_20171108_123622.jpg')}}"  width="100%" height="100%">
					</div>
				</div>
			</div>
		</div><!--Image row 1-->
